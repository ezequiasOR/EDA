...
class Fila<T> {
	...
	public String print() {
		String result = "";
		if (!isEmpty()) { result = this.lista.toString(); }
	...
	public void head() {
		if (!isEmpty()) { System.out.println(lista.toArray()[0]); }
...
class LinkedList<T>{
	...
	public void insert(T element) {
		if (isEmpty()) {
			...
			if (previous == null) { this.previous = new LinkedList<T>(); }
		...
		if (isEmpty()) { }
			...
			if (this.data.equals(element)) {
				if (this.previous.isEmpty() && this.next.isEmpty()) {
					...
					if (this.next != null) { this.previous = this; }
				}
	...
	public String toString() {
		String result = "";
		if (!isEmpty()) { result = this.data + " " + this.next.toString(); }
