...
class BSTNodePredecessor<T> {
	...
	public BSTNodePredecessor<T> getLeft() { return left; }

	public void setLeft(BSTNodePredecessor<T> left) { this.left = left; }

	public BSTNodePredecessor<T> getRight() { return right; }

	public void setRight(BSTNodePredecessor<T> right) { this.right = right; }

	public BSTNodePredecessor<T> getParent() { return parent; }

	public void setParent(BSTNodePredecessor<T> parent) { this.parent = parent; }
}